...
SQL is a languaged used to manage data in relational databases

2. Why do tables need a `primary key`?

Primary key is used to show what is the data being shown here, what is the main data the table is holding.
...
We need a seperate table showing the ids corresponding to the others' tables.
